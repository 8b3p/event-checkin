...
Guest card images are drawn in the owner's browser from the same
[`InviteCard`](features/guests/ui/InviteCard.tsx) component guests see on
`/i/[code]`, so a downloaded card always matches the real invitation — no
